...
from datasets.utils.public_dataset import PublicDataset, random_loaders, GaussianBlur, FourCropsTransform
...
class PublicMarket1501(PublicDataset):
    ...
    torchvision_normalization = transforms.Normalize((0.4145, 0.3887, 0.3840), (0.2172, 0.2095, 0.2088))
    ...
    def get_data_loaders(self):
        ...
        train_dataset = ImageDataset(Market1501(self.data_path).train, FourCropsTransform(selected_transform))
